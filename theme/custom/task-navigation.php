            ...
            <li class="create-ticket">
                <?php if ( is_user_logged_in() ) : ?>
                    <div class="zm-default-form-container">
                        <a href="javascript://" id="create_ticket" data-template="theme/custom/task-create.php" data-post_type="<?php print $post->post_type; ?>" class="button">Create a <?php print $post->post_type; ?></a>
                    </div>                
                <?php endif ?>
            </li>
        </ul>
